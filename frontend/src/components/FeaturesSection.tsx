...
const features = [
  ...
  },
  {
    ...
    icon: '🖼️',
    tag: 'Core',
    title: 'Convert to PNG or JPG',
    desc: 'Turn every page of a PDF into a high-quality image. Choose PNG (lossless) or JPG (smaller). One page = single image. Multiple pages = ZIP.',
    stat: '150',
